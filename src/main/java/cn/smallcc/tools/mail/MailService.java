...
public class MailService {
    ...
    public void userValidate(User user, String token) {
        ...
        try {
            ...
            String link = "http://www.smallcc.cn/validate/" + token;
