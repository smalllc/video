package cn.smallcc.parse.video;

import cn.smallcc.serv.model.Episode;
import cn.smallcc.dto.Video;
import cn.smallcc.parse.Parser;
import cn.smallcc.tools.JsoupUtils;
...
public class Imooc implements Parser<Video>{
  ...
  public Video parse(String url) {
    ...
    video.setValue(url);
    video.setParserName("smallcc");
    video.setParser("http://www.smallcc.cn");
    video.setType("H5");
